...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getSubTotal($products)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->getSubTotal($products);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getShipping($products)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->getShipping($products);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getVAT($product)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->getVAT($product);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function hasDiscount($products)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->hasDiscount($products);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getDetailedDiscount($products, $shoesOffer, $jacketOffer, $shippingOffer)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->getDetailedDiscount($products, $shoesOffer, $jacketOffer, $shippingOffer);
        }
                    /**
         * Get List
         *
...
namespace  { 
            ...
            class ProductFacade extends \App\Facades\ProductFacade {}
